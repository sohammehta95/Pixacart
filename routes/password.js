  ...
  async.waterfall([
    ...
    function(token, done) {
      ...
      User.findOne({ email: req.body.email }, (err, user) => {
        if (err) throw err;
        if (!user) {
          req.flash("error", "That Pixacart account doesn't exist.");
    ...
    function(token, user, done) {
      ...
      let mailOptions = {
        from: "naideneka@gmail.com",
        to: user.email,
        subject: "Reset your Pixacart Password",
  ...
  async.waterfall([
    ...
    function(user, done) {
      ...
      let mailOptions = {
        from: "naideneka@gmail.com",
        to: user.email,
        subject: "Your Pixacart Password has been changed",
        text: "Hi " + user.firstName + ",\n\n" +
